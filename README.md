...
| /products/{productId} | GET         | 특정 물건을 조회합니다.  |

관리자
| URI                | REQUEST METHOD | DESCRIPTION                  |
|--------------------|----------------|------------------------------|
| /admin/users       | GET                |관리자가 전체 회원을 조회합니다.|
| /admin/products     | POST           | 관리자가 새로운 물건을 등록합니다.      |
| /admin/products/{productId} | PATCH         | 관리자가 특정 물건 정보를 수정합니다.   |
| /admin/products/{productId} | DELETE      | 관리자가 특정 물건을 삭제합니다.        |
